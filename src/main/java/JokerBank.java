...
public class JokerBank {
    private static ArrayList<Joker> jokers = new ArrayList<>(
            List.of(
                    ...
                    new Joker("Greedy Joker", 5, 0, "Played cards with " + Color.orange(Suit.DIAMONDS.getSymbol() + "Diamond ") + "suit give " + Color.red("+3 ") + "Mult when scored"),
                    new Joker("Lusty Joker", 5, 0, "Played cards with " + Color.red(Suit.HEARTS.getSymbol() + "Heart ") + "suit give " + Color.red("+3 ") + "Mult when scored"),
                    new Joker("Wrathful Joker", 5, 0, "Played cards with " + Color.gray(Suit.SPADES.getSymbol() + "Spade ") + "suit give " + Color.red("+3 ") + "Mult when scored"),
                    new Joker("Gluttonous Joker", 5, 0, "Played cards with " + Color.blue(Suit.CLUBS.getSymbol() + "Club ") + "suit give " + Color.red("+3 ") + "Mult when scored"),
                    ...
                    new Joker("Ancient Joker", 8, 2, "Each played card with " + Color.orange("[suit] ") + "suit gives " + Color.redbg(Color.white("X1.5 ")) + "Mult when scored, suit changes at end of round"),
                    new Joker("Baseball Card", 8, 2, Color.green("Uncommon ") + "Jokers each give " + Color.redbg(Color.white("X1.5 ")) + "Mult"),
                    new Joker("Baron", 8, 2, "Each " + Color.orange("King ") + "held in hand gives " + Color.redbg(Color.white("X1.5 ")) + "Mult")
            )
            );
